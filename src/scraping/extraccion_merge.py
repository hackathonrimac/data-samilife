...
# --- DICCIONARIO MAESTRO DE ESPECIALIDADES (TOTAL: 229) ---
# Mapeo ID -> Nombre de Especialidad extraído del JSON oficial
...
def extraer_por_especialidad(id_esp, nombre_esp):
    ...
    try:
        ...
        if total_registros == 0:
            print(f"⚠️  No hay médicos programados para {nombre_esp}.")
            return
